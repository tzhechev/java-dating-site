...
INSERT INTO MESSAGES(MESSAGE_ID,MESSAGE_TIME,USER_FROM_ID,USER_TO_ID,MESSAGE_TEXT) VALUES (1,TO_DATE('27-JAN-2007'),1,2,'Hello!');
INSERT INTO MESSAGES(MESSAGE_ID,MESSAGE_TIME,USER_FROM_ID,USER_TO_ID,MESSAGE_TEXT) VALUES (2,TO_DATE('27-JAN-2007'),2,1,'Hello to you too!');
INSERT INTO MESSAGES(MESSAGE_ID,MESSAGE_TIME,USER_FROM_ID,USER_TO_ID,MESSAGE_TEXT) VALUES (3,TO_DATE('27-JAN-2007'),3,2,'What are you talking about?!');
INSERT INTO MESSAGES(MESSAGE_ID,MESSAGE_TIME,USER_FROM_ID,USER_TO_ID,MESSAGE_TEXT) VALUES (4,TO_DATE('27-JAN-2007'),1,3,'This is the fourth message so far!');
INSERT INTO MESSAGES(MESSAGE_ID,MESSAGE_TIME,USER_FROM_ID,USER_TO_ID,MESSAGE_TEXT) VALUES (5,TO_DATE('27-JAN-2007'),2,3,'Enough messages!');
